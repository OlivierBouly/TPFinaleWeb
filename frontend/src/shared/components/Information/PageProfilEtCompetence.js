...
function PageProfilEtCompetenceApp(props) {
    return(
        <React.Fragment>
            <div className="page-accueil">
                <div id="drawer-hook"></div>
                <h1 className="page-accueil_titre">Profils et Compétences des étudiants en Développement d'applications</h1>
...
la programmation structurée et orientée objet et Web dynamique
 ...
 l’assurance qualité logiciel</div>
            </div>
        </React.Fragment>
    );
}

    function PageProfilEtCompetenceRes(props) {
        return(
            <React.Fragment>
                <div className="page-accueil">
                    <div id="drawer-hook"></div>
                    <h1 className="page-accueil_titre">Profils et Compétences des étudiants en Réseau et sécurité</h1>
                    <div className="page-accueil_text">
...
préparation à la certification CEH (Certified Ethical Hacker)</div>
                </div>
            </React.Fragment>
        );
}

    function PageProfilEtCompetence(){
        var link = window.location.href;
        var linkParts = link.split('/');
        link = linkParts[linkParts.length - 1]

        if(link == 'profilApp'){
            return (<React.Fragment><a href="/profilRes">Afficher la page pour le profil Réseau et Sécurité</a><PageProfilEtCompetenceApp /></React.Fragment>);
        }
        return (<React.Fragment><a href="/profilApp">Afficher la page pour le profil Développement d'applications</a><PageProfilEtCompetenceRes /></React.Fragment>);
    }

export default PageProfilEtCompetence;